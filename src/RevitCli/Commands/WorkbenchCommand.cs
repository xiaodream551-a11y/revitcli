...
public static class WorkbenchCommand
{
    ...
    private static readonly WorkbenchCommandContract[] CommandContracts =
    {
        ...
        new(
            "env",
            "Capture local Revit machine baseline evidence before support or pilot work.",
            "read-only",
            SupportsJson: true,
            SupportsMarkdown: true,
            "none",
            "revit-env-baseline.v1 when --out is used",
            "revitcli env baseline --years 2024,2025,2026 --output markdown",
            "0 when evidence is captured even if values are unknown; 1 for invalid options or failed --out writes."),
        new(
            "inspect",
        ...
        new(
            ...
            SupportsJson: true,
            SupportsMarkdown: true,
            "required before installer launch and Revit.ini repair apply",
            "revit-library-check.v1, revit-library-download.v1, revit-library-install.v1, revit-library-repair-plan.v1, revit-library-repair-receipt.v1, revit-library-repair-rollback.v1, and linked revit-env-baseline.v1 evidence in approved receipts",
        ...
        new(
            "addins",
            "Audit and safely disable local Revit add-in manifests for support and load-order risks.",
            "local-write",
            SupportsJson: true,
            SupportsMarkdown: true,
            "required before manifest disable apply or rollback",
            "revit-addins-audit.v1, revit-addins-disable-plan.v1, revit-addins-disable-receipt.v1, revit-addins-disable-rollback.v1, and linked revit-env-baseline.v1 evidence in approved receipts",
            "revitcli addins audit --versions 2024,2025,2026 --output markdown",
            "0 when no error-level add-in risks are found; 1 for missing assemblies, duplicate ids, unreadable manifests, or invalid options."),
        new(
            "crash",
            "Analyze local Revit crash journals and collect verified diagnostic evidence.",
            "local-write",
            SupportsJson: true,
            SupportsMarkdown: true,
            "none for analyze/repro/verify; collect writes only the requested local evidence packet",
            "revit-crash-analysis.v1, revit-crash-repro.v1, revit-crash-collection.v1, revit-crash-redaction-report.v1, revit-crash-packet-manifest.v1, and revit-crash-packet-verify.v1",
            "revitcli crash analyze --year 2026 --since 24h --output markdown",
            "0 when crash evidence is analyzed, checklisted, collected, or verified; 1 for invalid options, missing evidence, failed collection writes, or packet integrity failures."),
        new(
            "check",
    ...
    private static readonly WorkbenchOutputContract[] OutputContracts =
    {
        ...
        new(
            ...
            SupportsMarkdown: true,
            "Read-only local Revit machine baseline with build, add-in, content, Desktop Connector, GPU, and runtime evidence."),
        new(
            "rvt-file-scan",
            "rvt scan",
            SupportsTable: true,
        ...
        new(
            ...
            SupportsMarkdown: true,
            "Dry-run and confirmed installer launch receipt with package hash, environment baseline reference, and post-install verify command."),
        new(
            "revit-library-repair-plan",
            "library repair-plan",
            SupportsTable: true,
            "revit-library-repair-plan.v1",
            SupportsMarkdown: true,
            "Reviewable and reversible Revit.ini FamilyTemplatePath repair plan without applying changes."),
        new(
            "revit-library-repair-receipt",
            "library repair-apply",
            SupportsTable: true,
            "revit-library-repair-receipt.v1",
            SupportsMarkdown: true,
            "Dry-run and confirmed Revit.ini FamilyTemplatePath repair receipt with rollback metadata and environment baseline reference."),
        new(
            "revit-library-repair-rollback",
            "library repair-rollback",
            SupportsTable: true,
            "revit-library-repair-rollback.v1",
            SupportsMarkdown: true,
            "Dry-run and confirmed rollback report for Revit.ini FamilyTemplatePath repairs."),
        new(
            "revit-addins-audit",
            "addins audit",
            SupportsTable: true,
            "revit-addins-audit.v1",
            SupportsMarkdown: true,
            "Read-only .addin manifest audit for missing assemblies, duplicate ids, shadowing, and development paths."),
        new(
            "revit-addins-disable-plan",
            "addins plan-disable",
            SupportsTable: true,
            "revit-addins-disable-plan.v1",
            SupportsMarkdown: true,
            "Reviewable profile-based .addin manifest disable plan without moving files."),
        new(
            "revit-addins-disable-receipt",
            "addins apply",
            SupportsTable: true,
            "revit-addins-disable-receipt.v1",
            SupportsMarkdown: true,
            "Dry-run and confirmed .addin manifest disable receipt with rollback metadata and environment baseline reference."),
        new(
            "revit-addins-disable-rollback",
            "addins rollback",
            SupportsTable: true,
            "revit-addins-disable-rollback.v1",
            SupportsMarkdown: true,
            "Dry-run and confirmed rollback report for disabled .addin manifests."),
        new(
            "revit-crash-analysis",
            "crash analyze",
            SupportsTable: true,
            "revit-crash-analysis.v1",
            SupportsMarkdown: true,
            "Read-only local Revit crash journal and Windows Application Event Log analysis."),
        new(
            "revit-crash-collection",
            "crash collect",
            SupportsTable: true,
            "revit-crash-collection.v1",
            SupportsMarkdown: true,
            "Local evidence packet with copied journals, analysis JSON, redaction report, README, and manifest."),
        new(
            "revit-crash-repro",
            "crash repro",
            SupportsTable: true,
            "revit-crash-repro.v1",
            SupportsMarkdown: true,
            "Clean Revit crash reproduction checklist for support handoff."),
        new(
            "revit-crash-packet-verify",
            "crash verify",
            SupportsTable: true,
            "revit-crash-packet-verify.v1",
            SupportsMarkdown: true,
            "Offline manifest, size, and hash verification for local crash evidence packets."),
        new(
            "schedule-create",
            "schedule create",
            SupportsTable: true,
    ...
    private static readonly WorkbenchSafeguardContract[] SafeguardContracts =
    {
        ...
        new(
            ...
            "revit-library-install.v1 plus linked revit-env-baseline.v1",
            "revitcli library check --year 2026 --locale ENU --output markdown",
            "Content installers are only started from an existing .exe/.msi package after --apply --yes and can write a launch receipt with package evidence."),
        new(
            "library-repair-apply",
            "library repair-apply",
            "local-write",
            "revitcli library repair-apply --plan .revitcli/plans/library-repair.json --dry-run --output markdown",
            "revitcli library repair-apply --plan .revitcli/plans/library-repair.json --yes --receipt-output .revitcli/receipts/library-repair.receipt.json --env-baseline .revitcli/evidence/env-baseline.json",
            "revit-library-repair-receipt.v1 plus linked revit-env-baseline.v1",
            "revitcli library repair-rollback --receipt .revitcli/receipts/library-repair.receipt.json --dry-run",
            "Revit.ini repair apply requires a reviewed plan, writes a backup and receipt, and exposes rollback before mutation."),
        new(
            "addins-apply",
            "addins apply",
            "local-write",
            "revitcli addins apply --plan .revitcli/plans/addins-disable.json --dry-run --output markdown",
            "revitcli addins apply --plan .revitcli/plans/addins-disable.json --yes --receipt-output .revitcli/receipts/addins-disable.receipt.json --env-baseline .revitcli/evidence/env-baseline.json",
            "revit-addins-disable-receipt.v1 plus linked revit-env-baseline.v1",
            "revitcli addins rollback --receipt .revitcli/receipts/addins-disable.receipt.json --dry-run",
            "Add-in manifest disable apply requires a reviewed plan, moves files only after --yes, and exposes rollback before mutation."),
        new(
            "history-prune",
            "history prune",
            "local-write",
    ...
    private static IEnumerable<WorkbenchCheckResult> BuildVerificationChecks(string projectDirectory)
    {
        ...
        {
            "export", "publish", "plan-apply", "rollback", "workflow-run", "deliverables-bundle", "issue-package", "schedule-create", "schedules-ensure", "views-template-apply", "views-clone-set", "links-repair", "model-map-fix", "sheet-issue-meta", "sheet-renumber", "rooms-renumber", "marks-assign", "rvt-clean-backups", "library-install", "library-repair-apply", "addins-apply"
        };
